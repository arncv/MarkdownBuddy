          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center text-blue-100">
                <button onClick={() => navigate('/documents')} className="hover:text-white">Documents</button>
              ...
              <div className="flex items-center space-x-4 text-sm">
                ...
                <div className="flex items-center text-blue-100">
                  <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15h18M3 9h18m-18 6h18" />
                  </svg>
                ...
                <div className="flex items-center text-blue-100">
                  ...
                  {Math.ceil(document.content.split(/\s+/).length / 200)} min read
                </div>
                <span className="text-blue-200">•</span>
                <div className="flex items-center text-blue-100">
                  {isLoading ? (
